...
import AditiImg from "../assets/Ar.Aditi-Saxena.webp";
...
const About = () => {
  const values = [
    {
      title: "Creativity",
      desc: "Pushing boundaries to deliver unique architectural solutions.",
      icon: Eye,
    },
    {
      title: "Precision",
      desc: "Attention to every detail from planning to execution.",
      icon: Target,
    },
    {
      title: "Sustainability",
      desc: "Integrating eco-friendly practices in our designs.",
      icon: CheckCircle2,
    },
    {
  ...
  return (
    <div className="pt-16 md:pt-32 bg-background">
      <Helmet>
        <title>About Us | A Square Studio</title>
        <meta
          name="description"
          content="Meet A Square Studio - an architectural and interior design firm serving New Delhi, Gwalior & Indore, dedicated to sustainable, functional, and beautiful spaces."
        />
        <link rel="canonical" href="https://asquarestudios.com/about" />
      </Helmet>
      {/* Hero Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-20 items-end">
          ...
          >
            ...
            <p className="text-secondary/60 text-lg leading-relaxed mb-8">
              A Square Studio is a premier architectural and interior design
              firm. Since our inception, we have been dedicated to creating
              spaces that are not only aesthetically pleasing but also highly
              functional and sustainable.
            </p>
            <p className="text-secondary/60 text-lg leading-relaxed mb-8">
              Our team brings a wealth of experience to every project, whether
              it's a luxury residential villa, a modern corporate office, or a
              bespoke interior space.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-32 bg-primary/30">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          {[
            {
              title: "Our Mission",
              icon: Target,
              text: "To create timeless spaces that reflect innovation, comfort, and functionality while exceeding expectations.",
            },
            {
              title: "Our Vision",
              icon: Eye,
              text: "To become one of India's leading studios, recognized for excellence, sustainability, and creative integrity.",
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
              ...
              className="bg-secondary/5 border border-secondary/10 p-6 md:p-12 md:hover:border-gold/30 transition-all duration-500"
            >
              <div className="w-16 h-16 bg-gold/10 flex items-center justify-center mb-8">
                <item.icon className="text-gold" size={32} />
              </div>
              <h3 className="text-secondary text-3xl font-serif mb-6">
                {item.title}
              </h3>
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="w-16 h-16 bg-gold/10 flex items-center justify-center mb-8 mx-auto group-hover:bg-primary/10">
                <value.icon
                  className="text-gold group-hover:text-primary transition-colors"
                  size={32}
                />
              </div>
              <h4 className="text-secondary text-xl font-serif mb-4 group-hover:text-primary transition-colors">
                {value.title}
              </h4>
              <p className="text-secondary/60 text-sm leading-relaxed group-hover:text-primary/80 transition-colors">
                {value.desc}
              </p>
            </motion.div>
          ))}
      ...
      {/* Team Section */}
      <section className="py-16 md:py-32 bg-primary/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {team.map((member, index) => (
              ...
              >
                ...
                <h4 className="text-secondary text-2xl font-serif mb-1">
                  {member.name}
                </h4>
