...
const Blog = () => {
  return (
    <div className="pt-32 bg-background min-h-screen">
      <Helmet>
        <title>Blog | Architecture & Design Insights | A Square Studio</title>
        <meta
          name="description"
          content="Insights on modern architecture, interior design trends, and studio news from A Square Studio."
        />
        <link rel="canonical" href="https://asquarestudios.com/blog" />
      </Helmet>
      {/* Hero */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto mb-20 mt-18">
        ...
        <p className="text-secondary/60 text-lg leading-relaxed max-w-3xl mb-12">
          Stay updated with the latest trends in modern architecture, interior
          design tips, and studio news.
        </p>
      </section>
